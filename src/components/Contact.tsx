...
export default function Contact() {
  ...
  const inputClass = "w-full bg-[#111111] border border-white/10 focus:border-[#F7941D] text-white placeholder-white/30 rounded-lg px-4 py-3.5 text-sm outline-none transition-colors duration-200";
  const labelClass = "block text-white/60 text-xs font-semibold tracking-wider uppercase mb-2";

  return (
    <section id="contact" className="py-28 bg-[#111111]">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            <div className="inline-flex items-center gap-2 mb-8">
              ...
              <span className="text-[#F7941D] text-xs font-semibold tracking-[0.2em] uppercase">Contact</span>
            </div>
            ...
            <div className="space-y-6">
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-[#0A0A0A] group-hover:bg-[#F7941D] flex items-center justify-center transition-colors duration-300">
                  <svg className="w-5 h-5 text-[#F7941D] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="flex items-center gap-4 group"
              >
                <div className="w-12 h-12 rounded-xl bg-[#0A0A0A] group-hover:bg-[#25D366] flex items-center justify-center transition-colors duration-300">
          ...
          <div className="bg-[#0A0A0A] border border-white/8 rounded-2xl p-8">
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                <div className="w-16 h-16 bg-[#F7941D]/10 rounded-full flex items-center justify-center mb-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-[#F7941D] hover:bg-[#E07810] disabled:opacity-60 text-white font-semibold py-4 rounded-lg transition-colors duration-200 text-sm tracking-wide"
                >
