...
export default function Contact() {
  ...
  const inputClass = "w-full bg-[#F4F0E8] border border-[#D9CBB8] focus:border-[#E77B00] text-[#1F1F1F] placeholder-[#5B3A29]/35 rounded-lg px-4 py-3.5 text-sm outline-none transition-colors duration-200";
  const labelClass = "block text-[#5B3A29]/65 text-xs font-semibold tracking-wider uppercase mb-2";

  return (
    <section id="contact" className="py-24 lg:py-32 bg-[#1F1F1F]">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20">
          ...
          <div>
            <div className="inline-flex items-center gap-2 mb-8">
              ...
              <span className="text-[#E77B00] text-xs font-semibold tracking-[0.2em] uppercase">Contact</span>
            </div>
            <h2 className="text-5xl lg:text-6xl font-semibold text-[#F4F0E8] leading-tight mb-4">
              {t("contact.title")}
            </h2>
            <p className="text-[#F4F0E8]/60 text-lg font-light mb-12">
              {t("contact.sub")}
            </p>

            <div className="space-y-6">
              <div className="text-xs font-semibold text-[#F4F0E8]/35 tracking-widest uppercase mb-4">
                {t("contact.or")}
              </div>

              <a href="tel:+13055426364" className="flex items-center gap-4 group">
                <div className="w-12 h-12 rounded-xl bg-[#F4F0E8]/8 group-hover:bg-[#E77B00] flex items-center justify-center transition-colors duration-300">
                  <svg className="w-5 h-5 text-[#E77B00] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <div>
                  <p className="text-[#F4F0E8]/40 text-xs uppercase tracking-wider">Phone / Call</p>
                  <p className="text-[#F4F0E8] font-semibold text-base">+1 (305) 542 6364</p>
                </div>
              </a>

              <a href="https://wa.me/13055426364" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                <div className="w-12 h-12 rounded-xl bg-[#F4F0E8]/8 group-hover:bg-[#25D366] flex items-center justify-center transition-colors duration-300">
                ...
                <div>
                  <p className="text-[#F4F0E8]/40 text-xs uppercase tracking-wider">WhatsApp</p>
                  <p className="text-[#F4F0E8] font-semibold text-base">+1 (305) 542 6364</p>
                </div>
              </a>

              <a href="mailto:combostudiopaint@gmail.com" className="flex items-center gap-4 group">
                <div className="w-12 h-12 rounded-xl bg-[#F4F0E8]/8 group-hover:bg-[#E77B00] flex items-center justify-center transition-colors duration-300">
                  <svg className="w-5 h-5 text-[#E77B00] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <p className="text-[#F4F0E8]/40 text-xs uppercase tracking-wider">Email</p>
                  <p className="text-[#F4F0E8] font-semibold text-base">combostudiopaint@gmail.com</p>
                </div>
              </a>
            </div>
          </div>
          ...
          {/* Form */}
          <div className="bg-[#F4F0E8] rounded-2xl p-8">
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                <div className="w-16 h-16 bg-[#E77B00]/10 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-8 h-8 text-[#E77B00]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <p className="text-[#1F1F1F] font-semibold text-xl">{t("contact.success")}</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-[#E77B00] hover:bg-[#C96900] disabled:opacity-60 text-white font-semibold py-4 rounded-lg transition-colors duration-200 text-sm tracking-wide"
                >
