        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          {tab === "signature" ? (
            <div className="flex flex-col gap-4">
              {/* Top photo — half width, centered */}
              <div className="flex justify-center">
                <div
                  className="relative h-72 w-1/2 overflow-hidden cursor-zoom-in group"
                  onClick={() => setLightbox("/images/pintor/34.png")}
                >
                  <Image
                    src="/images/pintor/34.png"
                    alt="Limewash wall finish - luxury home Miami green sage"
                    fill
